          ...
          <div className="contact-wrapper my-5">
            <div className="row cs">
              <motion.div
                ...
                transition={{ duration: 0.4, delay: 0.3 }}
              >
                 <div className="aboutus-container theriyala">
          <img
            src={background}
                ...
                <div className="contact-form">
                  <div className="contact-form-header">
                    ...
                    <motion.p
                      ...
                      transition={{ duration: 0.4, delay: 0.3 }}
                    >
                     Have questions or need assistance? Get in touch with us — we're here to support you every step of the way.
                    </motion.p>
                  </div>
